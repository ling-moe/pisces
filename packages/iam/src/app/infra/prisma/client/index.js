...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "packages/iam/src/app/infra/prisma/client",
    "iam/src/app/infra/prisma/client",
  ]
...
path.join(process.cwd(), "packages/iam/src/app/infra/prisma/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/iam/src/app/infra/prisma/client/schema.prisma")
